...
@Component({
  selector: 'app-alberghi',
  templateUrl: './alberghi.page.html',
  styleUrls: ['./alberghi.page.scss','bootstrap.min.css', 'style.css'],
})
export class AlberghiPage implements OnInit {
