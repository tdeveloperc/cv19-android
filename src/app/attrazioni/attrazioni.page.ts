...
@Component({
  ...
  templateUrl: './attrazioni.page.html',
  styleUrls: ['./attrazioni.page.scss','bootstrap.min.css', 'style.css'],
})
export class AttrazioniPage implements OnInit {
